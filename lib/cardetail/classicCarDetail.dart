...
class ClassicCarDetail extends StatelessWidget {
  @override
        ...
        children: [
          Expanded(
              ...
              child: Container(
                ...
                child: Image.asset('images/Classic_Car.png',
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Consumer(builder: (context, watch, child) {
                        final _isPressed = watch(classicCarViewModelProvider);
                        return GestureDetector(
                          onTap: () => context
                              .read(classicCarViewModelProvider.notifier)
                              .favorite(),
                          child: Icon(
                            _isPressed
                                ? Icons.star_rounded
