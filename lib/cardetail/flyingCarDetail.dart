...
class FlyingCarDetail extends StatelessWidget {
  @override
        ...
        children: [
          Expanded(
              ...
              child: Container(
                ...
                child: Image.asset('images/Flying_Car.png',
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Consumer(builder: (context, watch, child) {
                        final _isPressed = watch(flyingCarViewModelProvider);
                        return GestureDetector(
                          onTap: () => context
                              .read(flyingCarViewModelProvider.notifier)
                              .favorite(),
                          child: Icon(
                            _isPressed
                                ? Icons.star_rounded
